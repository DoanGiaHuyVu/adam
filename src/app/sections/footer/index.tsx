...
import bsmtTeamImg from "../../../../public/footer/footer.png";
import * as Scrollytelling from "~/lib/scrollytelling-client";
import QRImg from "../../../../public/footer/qrcode.svg";
import confetti from "canvas-confetti";

import s from "./footer.module.scss";
import Link from "next/link";
import { DottedDiv } from "../../components/dotted-container";
import basementTeamSVG from "../../../../public/footer/DREAMING-BIG.svg";
import { useMedia } from "../../../hooks/use-media";
import { toVw } from "../../../lib/utils";
import { useCallback, useEffect, useRef, useState } from "react";
import clsx from "clsx";

const ghHref = "https://www.linkedin.com/in/doan-gia-huy-vu-adam/";

export const Footer = () => {
  const isDesktopSm = useMedia("(min-width: 1024px)");

  return (
    <Scrollytelling.Root start="top 80%" debug={{ label: "Hit Me Up 🤙" }}>
      <footer className={s.footer}>
        ...
        <div className={s.links}>
          ...
          <div>
            ...
            <Link
              className="link"
              href="mailto:vudoangiahuy@gmail.com"
              target="_blank"
              rel="noreferrer"
            >
              vudoangiahuy@gmail.com
            </Link>
          </div>
          <div>
            <span>Template Inspired by @basement.studio llc {new Date().getFullYear()}</span>
  ...
  return (
    <div className={s["pre-footer"]}>
      ...
      <div className={s["left-content"]}>
        <p>
          Now we’re talking! Drop me a note using the contact form — questions, feedback, collabs… I’m all ears.
        </p>
        <Terminal />
        <a
    ...
    <>
      <div className={s.terminal}>
        ...
        <DottedDiv className={s.content}>
          <p ref={contentRef}>git clone linkedin.com/in/doan-gia-huy-vu-adam && cd connect</p>
          <button
            title="copy text"
...
const socials = [
  {
    name: "instagram",
    url: "https://www.instagram.com/adamonsieur/",
  },
  {
    name: "github",
    url: "https://github.com/DoanGiaHuyVu",
  },
  {
    name: "linkedin",
    url: "https://www.linkedin.com/in/doan-gia-huy-vu-adam/",
  },
];
